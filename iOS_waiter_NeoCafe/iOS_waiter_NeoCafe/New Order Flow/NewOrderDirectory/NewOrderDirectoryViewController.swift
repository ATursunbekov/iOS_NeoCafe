...
//            let selectedOrder = viewModel.order
//            viewModel.onNewOrderInfoDrawerNavigate?(selectedOrder)
        }
    }
}
...
extension NewOrderDirectoryViewController: ProductCellDelegate {
    func updateOrderButtonTotal() {
        ...
        let total = viewModel.getTotal(product: selectedProduct, quantity: selectedProduct.quantity)
        DispatchQueue.main.async {
