...
public class SVPinView: UIView {
    ...
    fileprivate var flowLayout: UICollectionViewFlowLayout {
        collectionView.collectionViewLayout = SVPinViewFlowLayout()
    ...
    @IBInspectable public var borderLineColor: UIColor = .black
    @IBInspectable public var activeBorderLineColor: UIColor = .black

    @IBInspectable public var borderLineThickness: CGFloat = 2
    @IBInspectable public var activeBorderLineThickness: CGFloat = 4

    @IBInspectable public var fieldBackgroundColor: UIColor = .clear
    @IBInspectable public var activeFieldBackgroundColor: UIColor = .clear
    ...
    @objc fileprivate func textFieldDidChange(_ textField: UITextField) {
        ...
        if !allowsWhitespaces && !isBackSpace() && textField.text?.trimmingCharacters(in: .whitespacesAndNewlines).count == 0 {
            return
        }
...
extension SVPinView: UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        textField.font = font
        textField.deleteButtonAction = deleteButtonAction
        if #available(iOS 12.0, *), indexPath.row == 0, isContentTypeOneTimeCode {
            textField.textContentType = .oneTimeCode
        }
        textField.keyboardType = keyboardType
        textField.keyboardAppearance = keyboardAppearance
        textField.inputAccessoryView = pinInputAccessoryView
